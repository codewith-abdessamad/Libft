...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/13 16:16:43 by abdessel          #+#    #+#             */
/*   Updated: 2025/10/13 21:52:20 by abdessel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_lstadd_front(t_list **lst, t_list *new); /*bonus*/
void		ft_lstadd_back(t_list **lst, t_list *new); /*bonus*/
